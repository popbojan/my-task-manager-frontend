export const de = {
  ...
  "tasks.hello": "Hallo, {{email}}",
  "tasks.summary": "{{open}} offene Aufgaben • {{overdue}} überfällig",
  "tasks.tagline": "Lass uns heute vorankommen.",
  "tasks.stats.open": "Offene Aufgaben",
  "tasks.stats.overdue": "Überfällig",
  "tasks.stats.completedToday": "Heute erledigt",
  "tasks.stats.streak": "Aktuelle Serie",
  "tasks.stats.streakDays": "{{days}} Tage",
  "tasks.stats.openHint": "Bleib fokussiert",
  "tasks.stats.overdueHint": "Priorisiere diese",
  "tasks.stats.completedHint": "Super gemacht!",
  "tasks.stats.streakHint": "Weiter so!",
